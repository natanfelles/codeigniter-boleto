...
$dadosboleto["nosso_numero"] = $this->cedente['nosso_numero'];  // Nosso numero sem o DV - REGRA: Máximo de 16 caracteres! (Pode ser um número sequencial do sistema, o cpf ou o cnpj)
...
$dadosboleto["carteira"] = $this->cedente['carteira'];  // Código da Carteira: pode ser SR (Sem Registro) ou CR (Com Registro) - (Confirmar com gerente qual usar)
