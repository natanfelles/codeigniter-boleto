...
$dadosboleto["nosso_numero"] = $this->cedente['nosso_numero'];  // Nosso numero - REGRA: Máximo de 13 digitos!
...
$dadosboleto["carteira"] = $this->cedente['carteira'];  // Código da Carteira
$dadosboleto["codigo_cedente"] = $this->cedente['conta_cedente'];
