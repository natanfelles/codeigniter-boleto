...
$dadosboleto["conta_cedente"] = $conta_cedente[0]; // ContaCedente do Cliente, sem digito (Somente 6 digitos)
$dadosboleto["conta_cedente_dv"] = $conta_cedente[1]; // Digito da ContaCedente do Cliente
$dadosboleto["carteira"] = $this->cedente['carteira'];  // Código da Carteira -> 5-Cobrança Direta ou 1-Cobrança Simples
