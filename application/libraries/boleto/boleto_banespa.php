...
$dadosboleto["nosso_numero"] = $this->cedente['nosso_numero'];  // Nosso numero - REGRA: Máximo de 7 caracteres!
...
$dadosboleto["carteira"] = $this->cedente['carteira'];  // COB - SEM Registro
