...
$dadosboleto["nosso_numero"] = $this->cedente['nosso_numero'];  // Nosso numero sem o DV - REGRA: Máximo de 8 caracteres!
...
$dadosboleto["conta"] = $this->cedente['conta']; 	// Num da conta corrente
$dadosboleto["agencia"] = $this->cedente['agencia']; 	    // Num da agência

// DADOS PERSONALIZADOS - BANESTES
$dadosboleto["carteira"] = $this->cedente['carteira']; // Carteira do Tipo COBRANÇA SEM REGISTRO (Carteira 00) - Não é Carteira 11
